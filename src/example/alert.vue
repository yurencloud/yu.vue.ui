<template>
  <div id="container" style="margin: 30px">
    ...
    <div class="web-sub-title" style="margin-top: 100px">警告</div>
    <yu-alert>温馨提示</yu-alert>

    <div class="web-sub-title" style="margin-top: 100px">多颜色</div>
    ...
    <div class="web-sub-title" style="margin-top: 100px">图标</div>
    ...
    <div class="web-sub-title" style="margin-top: 100px">警告---居中</div>
    ...
    <div class="web-sub-title" style="margin-top: 100px">警告---带有辅助性文字</div>
    ...
    <div class="web-sub-title" style="margin-top: 100px">警告---带有辅助性文字和icon</div>
    ...
    <div class="web-sub-title" style="margin-top: 100px">警告---关闭按钮为自定义文本</div>
    ...
    <yu-alert title="成功提示的文案" type="warning" show-icon description='尕尕尜尜过过,这是辅助性文字' @close="alerts"/>
    <div class="web-sub-title" style="margin-top: 100px">警告---不能关闭的警告框</div>
